...
namespace JecoreDotNetCommon.Web.WebPages
{
    public class CustomDisplayModeProviders
    {
        /// <summary>
        /// 全覆盖兼容性 判断是否为移动设备
        /// </summary>
        ...
        public bool IsMobile()
        {
            ...
            if (context.Request.ServerVariables["HTTP_USER_AGENT"] != null)
            {
                ...
                var sd = mobiles.Any(s => context.Request.ServerVariables["HTTP_USER_AGENT"].ToLower().Contains(s.ToLower()));
